...
const checkEndGame = () => {
  const disabledCards = document.querySelector('.disabed-card');

  if (disabledCards.length === 20) {
    alert('Parabéns, você ganhou. Conheça mais sobre os outros cursos :D')
  }
}
...
const checkCards = () => {
  ...
  if (firstCharacter === secondCharacter) {
    ...
    firstCard.classList.remove('reaveal-card');
    secondCard.classList.remove('reaveal-card');
